...
{
    class NoteSlotConsumer: BaseConsumer
    {
        // here we consume the Note Slot message, open the slot and ask the user to enter the money. 
        // this will validate the amount of entered money if it is a valid 20$ • 50$.
